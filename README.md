.. -*- mode: rst -*-
==========================================
 Keyboards for the Nenets language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Nenets language. The data and implementations
...
* http://giellatekno.uit.no/yrkdoc/index.html
* https://giellalt.uit.no/tools/docu-yrk-manual.html
...
The Nenets keyboard sources can be acquired using the `Giella SVN
